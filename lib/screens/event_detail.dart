            ...
            child: Column(
              ...
              children:  [
                Flexible(
                  ...
                  Text(event.title, style: const TextStyle(fontSize:20, fontWeight: FontWeight.bold, fontFamily: "Lato"),),
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                          Text('Тип мероприятия:  ${event.type}', style:const TextStyle(fontSize:16, fontFamily: "Lato" )),
                          Text('Дата:   ${event.date}', style:const TextStyle(fontSize:16, fontFamily: "Lato" )),
                          Text('Время:   ${event.time}', style:const TextStyle(fontSize:16, fontFamily: "Lato" )),
                        ],),
                      ),
      ...
      label: const Text('Найти'),
                ...
                Flexible(
                  ...
                  child: SingleChildScrollView(
                    child:Container(
                      padding: const EdgeInsets.only(top: 20, bottom: 10, left: 10, right: 10),
                      child: Text(event.description, style:const TextStyle(fontSize:16, fontFamily: "Lato"), textAlign: TextAlign.center,))
                  ))
              ],
            ),
